...
public class WizardItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Wizard_titulo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Wizard_titulo_feature", "_UI_Wizard_type"),
				 WizardPackage.Literals.WIZARD__TITULO,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WizardPackage.Literals.WIZARD__PAGINAS);
		}
	...
	public String getText(Object object) {
		String label = ((Wizard)object).getTitulo();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WizardPackage.Literals.WIZARD__PAGINAS,
				 WizardFactory.eINSTANCE.createPagina()));
	}
