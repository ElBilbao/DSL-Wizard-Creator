...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Mostrar</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link wizard.impl.MostrarImpl#getMensaje <em>Mensaje</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MostrarImpl extends BotonImpl implements Mostrar {
	/**
	...
	protected EClass eStaticClass() {
		return WizardPackage.Literals.MOSTRAR;
	}
	...
	public void setMensaje(String newMensaje) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WizardPackage.MOSTRAR__MENSAJE, oldMensaje, mensaje));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WizardPackage.MOSTRAR__MENSAJE:
				return getMensaje();
		}
